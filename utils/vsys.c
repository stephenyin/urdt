...
dispatch_queue_t timer_manager_queue() {
    ...
    dispatch_once(&onceToken, ^{
        timer_manager_queue = dispatch_queue_create("com.cloud.urdt", DISPATCH_QUEUE_SERIAL);
    });
